		...
		<div class="navbar navbar-inverse">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a href="new-tasks">New Task</a></li>
	...
	<c:choose>
						...
						<tbody>
							<c:forEach var="task" items="${tasks}">
								<tr>
									...
									<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${task.createdDate}"/></td>
									<td>${task.finished}</td>
		...
		<c:when test="${mode == 'MODE_NEW' || mode == 'MODE_UPDATE' }">
			<div class="container text-center">
				<h3>Manage Task</h3>
				<form class="form-horizontal" method="POST" action="save-tasks">
